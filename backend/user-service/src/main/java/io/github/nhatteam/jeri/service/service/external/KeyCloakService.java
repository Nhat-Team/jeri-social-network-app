...
public class KeyCloakService {
    ...
    public void createUser(UserDto request, String userId) throws Exception {
    ...
    public void updateUser(String userId, UserDto request) {
        String path = keycloakPath + "/admin/realms/${KEYCLOAK_REALM}/users/${USER_ID}".replace("${KEYCLOAK_REALM}", realm).replace("${USER_ID}", userId);
        String token = loginAccount(new AccountLogin(adminUsername, adminPassword)).get("access_token").toString();
